(function() {
  ...
  var oc = function() {
    ...
    ge = function(a, b, c) {
      1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j54", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(oc() + "/collect", a.join("&"),
        ua))
    };
  var h = function(a) {
      ...
      if (e) {
        ...
        if ("auto" != g) zc(c, e, b, g, ca, d) && (hc = !0);
          ...
          a: {
            ...
            for (l = g.length - 2; 0 <= l; l--) e.push(g.slice(l).join("."));e.push("none");l = e
          }
  ...
  var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
    ...
    Jc = function(a, b) {
      ...
      a: if (c = a.get(cc), c = E(M.location[c ? "href" : "search"], "_ga"))
        if (a.get(bc))
      ...
      a.get(Q) ||
        ((b = (b = O.gaGlobal && O.gaGlobal.vid) && -1 != b.search(/^(?:utma\.)?\d+\.\d+$/) ? b : void 0) ? (J(17), a.data.set(Q, b)) : (J(8), a.data.set(Q, ga())));
